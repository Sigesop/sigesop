...
class sistema extends funcionesPrimarias 
{
    ...
    {        
        ...
        {            
            ...
            else if( $this->estadoConexion )
            {
                ...
                $usuario = $this->consultaSimpleArrayNumerico( $sql, 'nombre_usuario', null );
                ...
                $datos = $this->consultaSimpleArrayNumericoMultiple( $sql );
                ...
                $consultaPagina = $this->consultaSimpleArrayNumerico( $sql, 'pagina_acceso_rol', null );
