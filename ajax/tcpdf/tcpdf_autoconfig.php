...
if (!defined('K_PATH_IMAGES')) {
	$tcpdf_images_dirs = array(K_PATH_MAIN.'../../css/images/', K_PATH_MAIN.'images/', '/usr/share/doc/php-tcpdf/examples/images/', '/usr/share/doc/tcpdf/examples/images/', '/usr/share/doc/php/tcpdf/examples/images/', '/var/www/tcpdf/images/', '/var/www/html/tcpdf/images/', '/usr/local/apache2/htdocs/tcpdf/images/', K_PATH_MAIN);
...
if (!defined('PDF_HEADER_LOGO')) {
	$tcpdf_header_logo = '';
	if (@file_exists(K_PATH_IMAGES.'cfe.jpg')) {
		$tcpdf_header_logo = 'cfe.jpg';
	}
...
if (!defined('PDF_CREATOR')) {
	define ('PDF_CREATOR', 'Comisión Federal del Electricidad');
}

if (!defined('PDF_AUTHOR')) {
	define ('PDF_AUTHOR', 'Comisión Federal del Electricidad');
}
