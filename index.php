...
<html>
	...
	<body>
		<noscript>
			<div class="alert alert-danger"><h4 class="text-center">Se ha detectado Javascript deshabilitado, por favor active la ejecución de Javascript en su navegador para el correcto fucionamiento de la página</h4></div>
			<div class="errorJavascript"></div>
		</noscript>
