	...
	documentoGeneradores: function( obj, arr_unidad, arr_licencia, suf ) 
	{
		...
		var 
			html =
				'<form class="form-horizontal" role="form" method="post">'+
					'<div id="formNumeroUnidad' + suf + '" class="form-group">'+
						...
						'<div class="col-sm-7">'+
							'<select id="numeroUnidad' + suf + '" class="form-control input-md" placeholder></select>'+
						'</div>'+
					'</div>'+
					...
					'<div class="form-group">' +
						...
						'<p class="col-sm-7">' +
							'<button id="btnNuevoGenerador' + suf + '" type="submit" class="btn btn-success"> <span class="glyphicon glyphicon-floppy-disk"></span> Guardar</button> ' +
			...
			doc = {
				...
				javascript: function () 
				{
					var $numero_unidad = $( doc.datos.numero_unidad.idHTML );
					...
					if ( !jQuery.isEmptyObject( arr_unidad ) ) 
						$numero_unidad.combo({
							arr: arr_unidad,
							campo: 'numero_unidad'
						});
