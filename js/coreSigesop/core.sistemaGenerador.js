		...
		html = 
			'<form id="form-sistema-generador-' + suf + '" class="form-horizontal" role="form" method="post">' +
				'<div class="form-group">' +
					...
					'<div class="col-sm-7">' +
						'<input name="nombre_sistema_aero" id="nombre-sistema-' + suf + '" type="text" class="form-control input-md eventoCambioMayuscula" placeholder="Ingrese nombre del sistema" >' +
					'</div>' +
				'</div>' +
				...
				'<div class="form-group">' +
					...
					'<div class="col-sm-7">' +
						'<input name="id_sistema_aero" id="id-sistema-' + suf + '" type="text" class="form-control input-md eventoCambioMayuscula" placeholder="Ingrese ID del sistema (2 digitos)">' +
					'</div>' +
				'</div>' +
