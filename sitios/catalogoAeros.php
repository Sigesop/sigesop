<?php include("conexion/conexionAeros.php");?>
<!doctype html>
<html lang="es">
	<head>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="alert alert-success"><h4 class="text-center">Catálogo de Aerogeneradores</h4></div>

			<ul id="pestanas" class="nav nav-tabs">
				<li class="active"><a href="#main" data-toggle="tab">Nuevo Aerogenerador</a></li>
				<li><a href="#main2" data-toggle="tab">Aerogeneradores Registrados <span id="badge_generadores" class="badge"></span></a></li>
			</ul>
			...
			<div class="tab-content">
				...
				<div class="tab-pane fade" id="main2"><br>
					...
					<div id="pestanaAerosRegistrados"></div>
				</div>
			</div>
		</div>
		...
		<script type="text/javascript" src="../js/coreSigesop/core.generadores.js"></script>
		<script type="text/javascript" src="../js/coreSigesop/main.generadores.js"></script>
	</body>
</html>