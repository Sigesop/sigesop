<?php include("conexion/conexionEquipos.php");?>
<!doctype html>
<html lang="es">
	<head>
	...
	<body>
		...
		<div class="container-fluid">
			<div class="alert alert-success"><h4 class="text-center">Catálogo de Equipos</h4></div>
			
			<ul id="pestanas" class="nav nav-tabs">
				<li class="active"><a href="#main" data-toggle="tab">Nuevo equipo</a></li>
				<li><a href="#main2" data-toggle="tab">Equipos registrados <span id="badge_equipoGenerador" class="badge"></span></a></li>
			</ul>
		...
		<script type="text/javascript" src="../js/coreSigesop/core.equipoGenerador.js"></script>
		<script type="text/javascript" src="../js/coreSigesop/main.equipoGenerador.js"></script>
	</body>
</html>