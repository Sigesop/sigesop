...
if ( !$obj->accesoPagina( 'materiales.php' ) ) {
    session_destroy();
...
<html lang="es">
	...
	<body>
		...
		<div class="container-fluid">
			<div class="alert alert-success"><h4 class="text-center">Catálogo de Materiales</h4></div>
			
			<ul id="pestanas" class="nav nav-tabs">
				<li class="active"><a href="#main" data-toggle="tab">Nuevo Material</a></li>
				<li><a href="#main2" data-toggle="tab">Materiales registrados <span id="badge_materiales" class="badge"></span></a></li>
			</ul>
		...
		<script type="text/javascript" src="../js/coreSigesop/core.materiales.js"></script>
		<script type="text/javascript" src="../js/coreSigesop/main.materiales.js"></script>
	</body>
</html>